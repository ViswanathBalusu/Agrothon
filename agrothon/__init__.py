...
if TELEGRAM_APP_ID == -1 or TELEGRAM_API_HASH is None or BOT_TOKEN is None or API_BASE_URL is None or ALERT_CHANNEL_ID == -1 or STATE is None or DISTRICT is None or DEF_CITY is None:
